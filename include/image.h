...
#ifdef CUDA
	Image* CUDA_filter_inora(const Image* in_img, const int r, int alpha, const float sigma, const float sigma2, const int iter);
#else
	Image* filter_inora(const Image* in_img, const int r, int alpha, const float sigma, const float sigma2, const int iter);
#endif
